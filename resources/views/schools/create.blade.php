...
@section('title', 'Add New School | Evos')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="reg_number" class="form-control @error('reg_number') is-invalid @enderror" 
                                           value="{{ old('reg_number') }}" placeholder="e.g. S0101" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                           value="{{ old('name') }}" placeholder="Enter school name" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" 
                                           value="{{ old('email') }}" placeholder="school@example.com" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="head_phone" class="form-control @error('head_phone') is-invalid @enderror" 
                                           value="{{ old('head_phone') }}" placeholder="e.g. 07XXXXXXXX" required>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex mt-2">
                                    <div class="custom-control custom-radio mr-4">
                                        <input class="custom-control-input" type="radio" id="gov" name="category" value="Government" checked>
                                        <label for="gov" class="custom-control-label">Government</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="private" name="category" value="Private">
